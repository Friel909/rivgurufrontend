...
module.exports = __webpack_require__("FWvS");
...
/* harmony import */ var bcrypt__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("jeq0");
...
/* harmony import */ var validator_lib_isEmail__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("R+uO");
...
/* harmony import */ var validator_lib_isLength__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("1TxS");
...
/* harmony import */ var _lib_init_middleware__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("BFcz");
/* harmony import */ var _models_index__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("Rc1n");
/* harmony import */ var _models_index__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_models_index__WEBPACK_IMPORTED_MODULE_7__);
...
const cors = Object(_lib_init_middleware__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])( // You can read more about the available options here: https://github.com/expressjs/cors#configuration-options
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  await cors(req, res);
  const confirmToken = Object(uuid__WEBPACK_IMPORTED_MODULE_2__["v4"])(); // Recieved params from request
  ...
  try {
    ...
    const user = await _models_index__WEBPACK_IMPORTED_MODULE_7__["users"].findOne({
      where: {
        email: email
      }
    });
    ...
    const passwordHash = await bcrypt__WEBPACK_IMPORTED_MODULE_1___default.a.hash(password, 10);
    const newUser = await _models_index__WEBPACK_IMPORTED_MODULE_7__["users"].create({
      name,
      email,
...
module.exports = JSON.parse("{\"development\":{\"username\":\"postgres\",\"password\":\"\",\"database\":\"edemy_database_development\",\"host\":\"127.0.0.1\",\"dialect\":\"postgres\"},\"test\":{\"username\":\"user\",\"password\":\"password\",\"database\":\"edemy_database_test\",\"host\":\"127.0.0.1\",\"dialect\":\"postgres\"},\"production\":{\"username\":\"user\",\"password\":\"password\",\"database\":\"edemy_database_production\",\"host\":\"127.0.0.1\",\"dialect\":\"postgres\"}}");
